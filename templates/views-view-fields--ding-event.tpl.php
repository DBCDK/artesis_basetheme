...
<?php $is_frontpage_teaser_list = ( !empty($fields['field_event_date_1']) ) ? TRUE : FALSE; ?>
<?php print '<div class="clearfix">'; ?>
<?php foreach ($fields as $id => $field): ?>
  <?php $column = ($id == 'field_list_image' || ($id == 'field_event_date' && $is_frontpage_teaser_list) ) ? 'left' : 'right'; ?>
